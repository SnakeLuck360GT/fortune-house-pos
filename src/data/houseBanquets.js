...
const BANQUET_SOUPS = [
  { id: 'hotsour',   en: 'Peking Hot & Sour Soup',  zh: '京汤', spicy: true },
  { id: 'sweetcorn', en: 'Chicken Sweetcorn Soup',  zh: '鸡米汤' },
]
...
export const BANQUETS = [
  {
    ...
    mains: [
      ...
      { id: 'im2', en: 'Fillet Steak with Cantonese Sauce',      zh: '中式牛柳' },
      { id: 'im3', en: 'Crispy Shredded Beef in Chilli Sauce',   zh: '干牛丝', spicy: true },
  ...
  },
  {
    ...
    soups: BANQUET_SOUPS,
    mains: [
      { id: 'pk1', en: 'Sweet & Sour Chicken',                          zh: '古老鸡', chicken: true },
